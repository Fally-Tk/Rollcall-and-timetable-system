        ...
        <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-black">
          ...
          <div className="flex items-center space-x-4 mt-4">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 text-black bg-white border-2 border-black hover:bg-black hover:text-white rounded-lg transition-colors"
            >
              <X className="w-4 h-4" />
              <span>Cancel</span>
            </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          <div className="col-span-full text-center py-8">
            ...
            <p className="text-black">Loading fields...</p>
          </div>
        ) : fields.length === 0 ? (
          <div className="col-span-full text-center py-12">
            <BookOpen className="w-16 h-16 text-black mx-auto mb-4" />
            <h3 className="text-lg font-medium text-black mb-2">No fields added yet</h3>
            <p className="text-black">Add your first academic field to get started.</p>
          </div>
        ) : (
          fields.map((field) => (
            <div key={field.id} className="bg-white rounded-xl p-6 shadow-lg border-2 border-black hover:shadow-xl transition-shadow">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-lg font-bold text-black">{field.name}</h3>
              ...
              {field.description && (
                <p className="text-black text-sm mb-4">{field.description}</p>
              )}
              
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-black" />
                  <span className="text-black font-medium">{field.totalStudents} students</span>
                </div>
